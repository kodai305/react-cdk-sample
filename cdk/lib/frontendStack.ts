...
export class CdkFrontStack extends Stack {
  constructor(scope: Construct, id: string, props?: AppStackProps) {
    ...
    const zone = route53.HostedZone.fromHostedZoneAttributes(this, 'HostZone', {
    ...
    // TODO: バケット名をつける
    const buildBucket = new aws_s3.Bucket(this, "BuildBucketSampleReactApp",{
    ...
    //デプロイするフォルダを指定
    new aws_s3_deployment.BucketDeployment(this, 'deploySampleFrontendApp', {
      sources: [aws_s3_deployment.Source.asset('../react-sample-app/build')],
